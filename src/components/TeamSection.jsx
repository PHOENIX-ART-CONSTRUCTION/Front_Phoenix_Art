...
const TeamSection = () => {
  ...
  return (
    <section id="équipes" className="w-full shadow-lg py-10 flex flex-col items-center" style={{ background: '#051D41' }}>
      <div className="max-w-6xl w-full flex flex-col items-center">
        ...
        <div className="relative w-full h-full">
          ...
          <div className="flex justify-center mt-6 space-x-4">
            <button onClick={handlePrev} aria-label="Précédent" className="text-gray-700 hover:text-[#be0b0b] transition duration-300">
              <ArrowCircleUp size={40} weight="fill" />
            </button>
            <button onClick={handleNext} aria-label="Suivant" className="text-gray-700 hover:text-[#be0b0b] transition duration-300">
